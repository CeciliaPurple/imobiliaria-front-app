...
const styles = StyleSheet.create({
  ...
  title: { width: '100%', fontSize: 20, fontWeight: 'bold', color: '#146FBA', backgroundColor: '#E3F2FF', padding: 10, textAlign: 'center', borderWidth: 2, borderColor: '#fff', marginTop: 10, marginBottom: 20 },
  container_imovel: { display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 15, marginBottom: 60 },
  ...
  emptyText: { fontSize: 18, fontWeight: 'bold', color: '#375A76', marginBottom: 10, textAlign: 'center' },
